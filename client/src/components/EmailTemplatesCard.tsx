        ...
        {isLoading ? (
          ...
          <>
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-green-50 p-4 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-green-700">Active Templates</p>
                    <p className="text-2xl font-bold text-green-900">{activeTemplates}</p>
                  </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-700">Inactive Templates</p>
                    <p className="text-2xl font-bold text-gray-900">{inactiveTemplates}</p>
                  </div>
            ...
            <div className="flex justify-end pt-4 border-t">
              <Button onClick={handleCreate} size="sm" className="bg-purple-600 hover:bg-purple-700">
